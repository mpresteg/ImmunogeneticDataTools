...
**Proposed, design-stage only — not yet a real Maven module, not in the
reactor above:** [`hla-report-extraction`](hla-report-extraction/README.md) —
extracting HLA typing results (as GL Strings) from lab report PDFs, the step
upstream of everything `ld-validation` already does. See its README for
